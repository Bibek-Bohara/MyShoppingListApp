...
class ApiProvider {
  ...
  Future<Map<String, dynamic>> post(String url, dynamic body,
    ...
    try {
      ...
      final dynamic response =
          await http.post(Uri.encodeFull(url), body: json.encode(body), headers: headers);
  ...
  Future<Map<String, dynamic>> put(String url, dynamic body,
    ...
    try {
      ...
      final dynamic response =
      await http.put(Uri.encodeFull(url), body: json.encode(body), headers: headers);
      responseJson = _response(response);
    } on SocketException {
      throw FetchDataException('No Internet connection');
    }
  ...
  Future<dynamic> delete(String url, {String token = '', dynamic query}) async {
    dynamic responseJson;
    try {
      final headers = {
        'content-type': 'application/json',
